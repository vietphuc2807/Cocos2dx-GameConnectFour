...
Scene* GameNormalScene::createScene()
{
	return GameNormalScene::create();
}

bool GameNormalScene::init()
{
	if (!Scene::init())
	{
		return false;
...
void GameNormalScene::updatePlayerInfoUI()
{
...
void GameNormalScene::showPauseMenuPopup() {
	auto Size = Director::getInstance()->getVisibleSize();
	auto Origin = Director::getInstance()->getVisibleOrigin();
...
void GameNormalScene::initBoard()
{
...
void GameNormalScene::dropPiece(int col)
{
...
void GameNormalScene::startCountdown()
{
	auto size = Director::getInstance()->getVisibleSize();
...
void GameNormalScene::switchTurn()
{
